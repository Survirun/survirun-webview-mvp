...
import { Test, ItemGet, StoryPage3, Battle, SubCharacter, SubCharacterCheck, DeathPage, Lobby, ZombieHPDown, JsonTest } from './pages';
    ...
    <InventorySelectDialog>
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<JsonTest/>} path="json-test"/>
        </Routes>
      </BrowserRouter>
    </InventorySelectDialog>
    </AlertDialog>
