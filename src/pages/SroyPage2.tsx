...
//     const [storyNumber, setStoryNumber] = useState(101)
//     const optionNumber = StoryData.storys[storyNumber/100].options?.length;
...
//         const [target, plusOrMineus, item] = (StoryData.storys[storyNumber/100].progress[storyNumber%100].options[optionNumber].result as string).split("_");
//         switch (target) {
//             case "health": 
//                 (plusOrMineus === "+") ?
