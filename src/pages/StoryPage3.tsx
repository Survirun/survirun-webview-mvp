  ...
  return (
    ...
    <div className="w-screen h-screen relative bg-white">
        <div className="w-full px-5 py-4 flex gap-2">
            ...
            <button className="p-1.5 bg-black rounded-[100px] shadow justify-start items-start gap-[5.71px] flex">
...
const Img = styled.img`
  ...
  background: url("https://i.pinimg.com/564x/1c/cf/f0/1ccff0a256a5dfd24bf32782326582f7.jpg"),
...
const Frame3 = styled.div`
  ...
  border-radius: 100px;
  background: #000;
  box-shadow: 0px 0px 13.71428px 0px rgba(0, 0, 0, 0.08);
`;
