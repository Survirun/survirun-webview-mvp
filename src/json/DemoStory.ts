      ...
      progressStory: [
        {
          progressID: progressID(4, 1),
          storyText: "당근이세요...?",
          optionNumber: [optionID(4, 1), optionID(4, 2), optionID(4, 3)]
        },
        {
          progressID: progressID(4, 2),
