        ...
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center z-10">
            ...
            <div className="flex items-center justify-center flex-col gap-3">
                <div className="w-72 justify-center items-start gap-2 inline-flex">
                    <button onClick={onClickLeft} className="w-36 h-10 p-2 bg-gray-100 rounded-xl justify-center items-center flex text-zinc-900 text-[13px] font-semibold z-[11] active:bg-gray-200 active:scale-90 duration-200 ease-in-out">{leftText}</button>
                    <button onClick={() => {if(selectInvenItem !== undefined) return onClickRight(selectInvenItem)}} disabled={(selectInvenItem === undefined)} className="w-36 h-10 p-2 bg-red-600 rounded-xl justify-center items-center flex text-white text-[13px] font-semibold z-[11] active:bg-red-500 active:scale-90 duration-200 ease-in-out disabled:bg-gray-400 disabled:pointer-events-none">{rightText}</button>
                </div>
