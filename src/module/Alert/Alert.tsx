        ...
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center z-10">
            ...
            <div className="w-80 h-44 p-4 bg-white rounded-lg flex-col justify-start items-start gap-5 inline-flex z-[11]">
                ...
                <div className="w-72 justify-start items-start gap-2 inline-flex">
                    <button onClick={onClickLeft} className="w-36 h-10 p-2 bg-gray-100 rounded-xl justify-center items-center flex text-zinc-900 text-[13px] font-semibold hover:opacity-80">{leftText}</button>
                    <button onClick={onClickRight} className="w-36 h-10 p-2 bg-red-600 rounded-xl justify-center items-center flex text-white text-[13px] font-semibold hover:opacity-80">{rightText}</button>
                </div>
            </div>
        </div>
    );
